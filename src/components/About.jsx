...
const About = () => {
    return (
        <section id="otherside" className="relative py-20 bg-[#141414] text-white overflow-hidden scroll-mt-28">
                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="w-full md:w-1/2">
                        ...
                        <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                            Join us for 1 day of intense competition, mind-bending puzzles, and groundbreaking tech talks.
