...
const Events = () => {
    ...
    const events = [
        { id: 1, title: "Stranger Bugs", match: "98% Match", age: "16+", duration: "2h", image: event1 },
        { id: 2, title: "Mindflayer Cup", match: "95% Match", age: "18+", duration: "2h", image: event2 },
        { id: 3, title: "Upsidedown Vision", match: "99% Match", age: "All", duration: "2h", image: event3 },
        { id: 5, title: "Stranger Sites", match: "97% Match", age: "16+", duration: "2h", image: event5 },
        { id: 4, title: "Hawkins Mystery Trail", match: "94% Match", age: "13+", duration: "2h", image: event4 },
        { id: 6, title: "Strange Shorts", match: "96% Match", age: "16+", duration: "2h", image: event1 },
    ];

    return (
        <section id="episodes" className="py-12 bg-[#141414] relative z-10 -mt-20 scroll-mt-28">
