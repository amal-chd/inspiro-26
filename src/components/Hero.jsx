...
import { Play, Info, Volume2, VolumeX, Trophy } from 'lucide-react';
...
const Hero = () => {
    ...
    return (
        <section id="hero-section" className="relative h-[100dvh] w-full overflow-hidden">
            {/* Video Background */}
                ...
                <div className="max-w-4xl w-full flex flex-col items-center text-center">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center gap-3 md:gap-4">
                            ...
                            <Link to="/champions" className="flex items-center gap-2 px-4 py-2 md:px-8 md:py-3 bg-gray-500/70 text-white rounded hover:bg-gray-500/50 transition font-bold text-sm md:text-lg backdrop-blur-sm">
                                <Trophy className="w-4 h-4 md:w-6 md:h-6" /> Champions
                            </Link>
                        </div>
                    </motion.div>
                </div>
